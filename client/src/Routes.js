...
import ChatsPage from "./user/ChatPage";
import ManageProducts from "./admin/ManageProducts";
import UpdateProduct from "./admin/UpdateProduct";
import CategoryList from "./admin/CategoryList";
import NotFound from "./core/NotFound";
import ChatComponent from "./user/UserChat";
import AdminChatComponent from "./admin/AdminChat";
  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <PrivateRoute path="/user/chat" component={ChatComponent} exact />
        <AdminRoute path="/admin/dashboard" component={AdminDashboard} exact />
        <AdminRoute path="/admin/chat" component={AdminChatComponent} exact />
        ...
        <PrivateRoute path="/chat/" component={ChatsPage} exact />
